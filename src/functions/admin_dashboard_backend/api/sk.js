    ...
    for (const field of requiredFields) {
      if (!formData[field]) {
        Swal.fire({
          ...
          text: `Please select ${fieldLabels[field]}.`,
        });
        return;
      }
    }
      ...
      if (formData.service_type === "Surgery") {
        if (!receiptFile) {
          Swal.fire({
            icon: "error",
            title: "Error",
            text: "Payment receipt is required for surgeries.",
          });
          return;
        }
      ...
      html: `
        <div class="booking-summary">
          <div class="summary-row">
            ...
            <span class="summary-value">${formData.first_name}</span>
          </div>
          <div class="summary-row">
            <span class="summary-label">Last Name:</span>
            <span class="summary-value">${formData.last_name}</span>
          </div>
          <div class="summary-row">
          ...
          <div class="summary-row">
            <span class="summary-label">Contact No.:</span>
    ...
    for (const field of requiredFields) {
      if (!formData[field]) {
        Swal.fire({
          icon: 'error',
          title: 'Missing Information',
          text: `Please fill in ${fieldDisplayNames[field] || field.replace(/_/g, ' ')}.`,
        });
        return;
      }
    }
