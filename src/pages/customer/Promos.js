...
const PromoCard = ({
  ...
  const handleClick = (e) => {
    if (
      e.target.classList.contains("see-more-link") ||
      ...
      >
        <div>
          ...
          >
            ...
            {description &&
              (description.split(" ").length > MAX_WORDS ||
...
function PromosPage() {
    ...
    const fetchPromos = async () => {
      try {
        const response = await fetch(
          "https://teal-seahorse-572802.hostingersite.com/backend/admin_dashboard_backend/nav_fetch_promos.php",
          {
            credentials: "include",
          }
        );
        ...
        const formattedData = promosArray.map((promo) => ({
          ...
          price:
            promo.price && typeof promo.price === "string"
              ? promo.price
  ...
  const handleBookNow = (promoId, promoTitle) => {
    navigate(
      `/booking?type=Promo&serviceId=${promoId}&promoName=${encodeURIComponent(
        promoTitle
      )}`
    );
  };
  ...
  return (
    <>
      <div
        ...
        style={{ backgroundImage: "url('./assets/asr_promo.jpg')" }}
      >
            ...
            >
              ...
              >
                ...
                <div style={{ flex: 2 }}>
                  ...
                  <small className="text-muted">
                    Valid: {selectedPromo.start_date} - {selectedPromo.end_date}
                  </small>
              ...
              <div style={{ display: "flex", justifyContent: "flex-end" }}>
                <button
                  ...
                  onMouseOver={(e) =>
                    (e.target.style.backgroundColor = "#a2bf5a")
                  }
                  onMouseOut={(e) =>
                    (e.target.style.backgroundColor = "#6cb33f")
                  }
                >
                  Book Now
                </button>
