...
-- Dumping data for table asr.bookings: ~0 rows (approximately)
...
-- Dumping data for table asr.products: ~3 rows (approximately)
...
-- Dumping data for table asr.surgeries: ~0 rows (approximately)
...
-- Dumping structure for table asr.surgery_appointments
...
-- Dumping data for table asr.surgery_appointments: ~0 rows (approximately)
...
INSERT INTO `users` (`id`, `first_name`, `middle_initial`, `last_name`, `email`, `password`, `contact_no`, `verified`, `verification_token`, `role`, `reset_token`, `reset_token_expiry`) VALUES
	(45, 'Randolph', 'Diosell', 'Alvarado', 'alvaradorandolph@gmail.com', '$2y$10$r6iq010vI/2lEB.wjoafS.xt93wW7w2mmRbJ/hoL7CncflKwzeDTK', '09052752202', 1, NULL, 'customer', '7e0f066584dc8d14de8b482c9156da4b308014ce8cc63307ac40e10a1dd12d47', '2025-03-20 09:11:16'),
	(46, 'Armand', 'G', 'Ledor', 'armand@yahoo.com', '$2y$10$N4Uqbn0G4bxBuvqayYaHIezFzVZbV6FSQjzoaV9I9t89u.VPswu1a', '09123456789', 1, NULL, 'admin', NULL, NULL);
