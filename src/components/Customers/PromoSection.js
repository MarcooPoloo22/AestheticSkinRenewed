    ...
    const fetchPromos = async () => {
      try {
        const response = await fetch(
          "backend/admin_dashboard_backend/home_fetch_promos.php"
        );
                ...
                <div key={promo.id} className="px-2 h-100">
                  ...
                  >
                    ...
                    <Card.Body className="d-flex flex-column">
                      <Card.Title className="ezy__epcategory2-title text-center">
                        {promo.title}
                      </Card.Title>
                      <Card.Text className="ezy__epcategory2-description flex-grow-1">
                        {truncateDescription(promo.description)}
                        {promo.description &&
                          (promo.description.split(" ").length > MAX_WORDS ||
                            promo.description.length > MAX_CHARS) && (
                            <span
                      ...
                      <div className="mt-auto">
                        <Card.Text className="ezy__epcategory2-price text-center">
                          Price: ₱{promo.price}
                        </Card.Text>
                        <button
            ...
            >
              ...
              >
                ...
                <div style={{ flex: 2 }}>
                  ...
                  <p className="ezy__epcategory2-price">
              ...
              <div style={{ display: "flex", justifyContent: "flex-end" }}>
                <button
                  onClick={(e) => {
                    ...
                    navigate(
                      `/booking?serviceId=${selectedPromo.id}&type=Promo`
                    );
                  }}
                  style={{
                    padding: "8px 16px",
